        ...
        <section className="relative">
            ...
            <div className="mt-[5rem] md:mt-[10rem] px-5 md:mx-auto max-w-5xl" >
                ...
                <div className="text-gray-700 text-base md:text-lg mb-[1rem] md:mb-[2rem] md:text-center" data-aos="zoom-y-out">
                    <p className="max-md:inline text-xl md:text-3xl font-bold mb-1">Q. </p>Struggling to find items in your bookmarks or <br />  dealing with too many screenshots to capture information from webpages?
                </div>
