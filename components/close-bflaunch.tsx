        ...
        <section className="relative">
            ...
            <div className="pt-28 pb-40 md:pb-60 md:pt-40 mx-5 md:mx-auto max-w-3xl">
                ...
                <div className="md:text-center">
                    <h1 className="font-rubik text-2xl md:text-4xl leading-tighter tracking-tighter mb-[2rem] md:mb-[5rem] text-center font-bold" data-aos="zoom-y-out">
                    ...
                    <div className="md:text-lg text-base text-center text-gray-700 mb-2" data-aos="zoom-y-out">It's free!</div>
