    ...
    return (
        <section className="relative">
            <div className="md:mx-auto max-w-6xl px-5 md:text-center my-auto">
                <h1 className="font-urbanist text-xl md:text-4xl leading-tighter tracking-tighter mb-[5rem] md:mb-[10rem] md:mt-[10rem] font-semibold" data-aos="zoom-y-out">
                    Organize data from web searches on a mobile browser
                    <p className="inline text-brown">
                        <br />so you can utilize it efficiently
                    </p>
                </h1>
                <div className="mb-[3rem] md:mb-[10rem]">
                ...
                <h1 className="mb-[4rem] md:mb-[10rem] font-urbanist text-xl md:text-4xl leading-tighter tracking-tighter mb-[2rem] md:mb-[5rem] font-semibold" data-aos="zoom-y-out">
