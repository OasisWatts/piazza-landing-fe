        ...
        <section className="relative">
            ...
            <div className="mt-[5rem] md:mt-[10rem] px-5 md:mx-auto max-w-5xl" >
                ...
                <div className="text-gray-700 text-base md:text-lg mb-[1rem] md:mb-[2rem] md:text-center" data-aos="zoom-y-out">
                    ...
                    You might sometimes use bookmarks or take screenshots to save information, but <p className='round-underline round-underline-lightbrown font-semibold text-black inline'>dealing with numerous web pages, remembering their contents, and quickly finding the specific page you need</p> can be quite challenging.
                </div>
                <div className='md:flex md:flex-row md:items-center'>
                    <div className="md:w-full mx-auto text-gray-700 text-base md:text-lg text-gray-600" data-aos="zoom-y-out" data-aos-delay="300">
                        <p className="max-md:inline text-xl md:text-3xl font-bold mb-1">A. </p><p className="round-underline round-underline-lightbrown font-semibold text-black">Use hashtags instead</p> to save details more efficiently. You can search for them easier by using tags.
                    </div>
