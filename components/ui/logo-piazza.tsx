...
class piazzaLogo extends Component<any> {
    render() {
        return (
            <svg width="current" height="current" viewBox="0 0 271 70" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" {...this.props}>
